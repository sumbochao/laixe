			...
			<div class="container">
				<div class="row">
					...
					<div class="col col-md-6">
						<div class="media wow fadeInLeft" data-wow-delay=".3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
					...
					<div class="col col-md-6">
						<div class="media wow fadeInRight" data-wow-delay=".3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
						  <div class="media-left">
						    <a href="#">
						      <img src="img/service-img.png" alt="">
						    </a>
